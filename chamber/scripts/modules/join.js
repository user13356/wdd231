document.addEventListener("DOMContentLoaded", () => {
    ...
    const modalContent = {
        npModal: {
            title: "Non Profit",
            content: "Basic and helpfull resources to improve nature.",
        },
        bronzeModal: {
            title: "Bronze",
            content:
                "Special offers, meet at gala and group meets.",
        },
        silverModal: {
            title: "Silver",
            content:
                "Bronze and extra added from Silver to meet with elite people in business.",
        },
        goldModal: {
            title: "Gold",
            content:
                "Top service with SLA, private line, and secret events.",
        },
    };
